...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query->bindParam(':DataNasc', $dob, PDO::PARAM_STR);
...
?>
    ...
    <head>
        ...
        <title>Admin | Atualizar Usuário</title>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Atualização do Usuário</div>
                </div>
                        ...
                        <div class="card-content">
                            <form id="example-form" method="post" name="updatemp">
                                <div>
                                    ...
                                    <?php if ($error) { ?><div class="errorWrap"><strong>ERRO</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php } ?>
                                    <section>
                                        <div class="wizard-content">
                                            <div class="row">
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {               ?>
                                                                <div class="input-field col  s12">
                                                                    <label for="empcode">Código do Usuário</label>
                                                ...
                                                <div class="input-field col s12">
                                                    <button type="submit" name="update" id="update" class="waves-effect waves-light btn indigo m-b-xs">ATUALIZAR</button>
