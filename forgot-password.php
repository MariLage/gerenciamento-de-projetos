...
<head>
    ...
    <title>Prefeitura | Recuperação de senha</title>
...
<body>
    ...
    <div class="mn-content fixed-sidebar">
        <header class="mn-header navbar-fixed">
            <nav class="blue"> <!-- mudar a cor do header -->
                <div class="nav-wrapper row">
                    ...
                    <div class="header-title col s3">
                        <span class="chapter-title">Prefeitura</span>
                    </div>
        ...
        <aside id="slide-out" class="side-nav white fixed">
            <div class="side-nav-wrapper">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" >
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons">account_box</i>Login do usuário</a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Recuperar senha</a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>Admin Login</a></li>
                </ul>
                <div class="footer">
                    <p class="copyright">Prefeitura ©</p>
                </div>
            </div>
        </aside>
        <main class="mn-inner">
                ...
                <div class="col s12">
                    ...
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card white darken-1">
                            ...
                            <div class="card-contentt" style="padding-top: 30px;">
                            <h5 style = "font-weight: bold; text-align:center;" > Detalhes do usuário</h5>
                                <?php if ($msg) { ?><div class="succWrap"><strong>SUCCESSO </strong> : <?php echo htmlentities($msg); ?> </div><?php } ?>
                                <div class="row">
                                    <form class="col s12" name="signin" method="post">
                                        <div class="input-field col s14 m6">
                                            <input id="empid" type="text" name="empid" class="validate" autocomplete="off" required>
                                            <label for="email">ID do Usuário</label>
                                        </div>
                                        <div class="input-field col s13 m6">
                                            <input id="password" type="text" class="validate" name="emailid" autocomplete="off" required>
                                            <label for="password">Email</label>
                                        </div>
                                        <div class="col s12" style="margin-bottom: 20px;">

                                            <input type="submit" name="submit" value="Trocar" class="btn fade_8S">
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            ?>
                                    ...
                                    <div class="row" >
                                        <h5 style = "font-weight: bold; text-align:center;" > Atualizar senha </h5>
                                        <form class="col s12" name="udatepwd" method="post">
                                            ...
                                            <div class="input-field col s12" style="margin-bottom: 20px;">
                                                <button type="submit" name="Atualizar senha" class="btn fade_8S" onclick="return valid();">Change</button>
                                ...
                                <?php } else { ?>
                                    <div class="errorWrap" style="margin-left: 2%; font-size:22px;">
                                        <strong>ERRO</strong> : <?php echo htmlentities("Detalhes");
                                                            } ?>
                                    </div>
                                <?php } ?>
